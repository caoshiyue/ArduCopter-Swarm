...
uint16_t Plane::get_recv_add()
{
    //return gcs_chan[MAVLINK_COMM_2].xbee_get_recv_add(); how it expressses in copter
    return gcs().chan(MAVLINK_COMM_2).xbee_get_recv_add();
}
#endif
...
void GCS_MAVLINK_Plane::handleMessage(mavlink_message_t* msg)
{
    ...
    case MAVLINK_MSG_ID_GLOBAL_POSITION_INT: //  msg id: 33
    {
        ...
        plane.record_flock_posvel(msg->sysid, packet);
        break;
    }
#endif
    ...
    case MAVLINK_MSG_ID_MISSION_MANAGE: // MAV ID: 94
    {
        ...
        plane.handle_mission_select(packet.start, packet.mission_num);
        break;
    }
    case MAVLINK_MSG_ID_MISSION_PARAM: // MAV ID: 95
    {
        ...
        plane.handle_set_para(packet.mission_id,packet.param_uint,packet.param_float);
        break;
    }
#endif
