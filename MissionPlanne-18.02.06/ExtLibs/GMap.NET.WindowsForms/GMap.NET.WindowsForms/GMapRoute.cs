...
namespace GMap.NET.WindowsForms
{
...
#endif
    {
...
#if !PocketPC
        public static readonly Pen DefaultStroke = new Pen(Color.FromArgb(144, Color.MidnightBlue), 1);
#else
        ...
        /// </summary>
        //[NonSerialized]
        public Pen Stroke = new Pen(Color.FromArgb(144, Color.MidnightBlue), 2);  // DefaultStroke;
        ...
        private Color GetColor(byte b)
        {
            switch(b%5)
            {
                ...
                case 1: return Color.MediumSeaGreen;
                case 2: return Color.MediumSlateBlue;
                case 3: return Color.MediumVioletRed;
                case 4: return Color.MediumOrchid;
                default: return Color.Black;
            }
        }
        public GMapRoute(IEnumerable<PointLatLng> points, string name,byte _id=255)
            : base(points, name)
        {
            id = _id;
            Stroke.Color = GetColor(id);
        }
