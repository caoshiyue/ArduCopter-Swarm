...
namespace MissionPlanner.Maps
{
    ...
    public class GMapMarkerQuad : GMapMarker
    {
        ...
        public override void OnRender(Graphics g)
        {
            ...
            g.DrawImage(icon, icon.Width / -4 , icon.Height / -4, icon.Width / 2, icon.Height / 2);
            g.DrawString(sysid.ToString(), new Font(FontFamily.GenericMonospace, 12, FontStyle.Bold), Brushes.Red, icon.Width / -4+6,
                icon.Height / -4+6);
